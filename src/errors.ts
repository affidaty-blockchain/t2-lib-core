...
export const WRONG_TX_NONCE_LENGTH = 'Transaction nonce must be 8 bytes long';
...
export const CERT_INVALID_FIELDS = 'Invalid certificate field.';
...
export const BULK_NO_FIELD = 'No such field for bulk transaction. Please see inner transactions.';
export const ONLY_NODE_FIELD = 'This field is only available for bulk node transaction.';
