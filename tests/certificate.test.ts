...
describe('certificate', () => {
    ...
    const dataToCertify = {
        ...
        phone: '(181) 846-2786',
        iban: 'TR212389546118441552663335',
    };
    const salt = '6a8aa06f8603e79ca8f4b0073d01f1be12a52dca35bd00722d6a4a20e354144e';
    ...
    test('t1', async () => {
        const cert = new Certificate()
            .setDataToCertify(dataToCertify)
            .setSalt(salt)
