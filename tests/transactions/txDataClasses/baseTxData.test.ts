...
import { BaseTxData } from '../../../src/transaction/baseTxData';
...
describe('base tx data class', () => {
    ...
    test('methods', async () => {
        // aSDASDASD
        let data: BaseTxData;
        data = new BaseTxData().setTypeTag('myType');
        expect(data.typeTag).toEqual('myType');
